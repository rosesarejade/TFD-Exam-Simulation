...
def solution_B5():
    ...
    test_predict = model.predict(test_set).flatten()

    # Taking the first few samples of the test data
    test_predict = test_predict[:500]
    test_valid = x_valid[:500]

    # Plot actual values against prediction result
    plt.plot(test_valid, label='actual')
